...
class Iching():
    ...
    def upper_lowergua_code(self, gua1, gua2):
        gua_dict = dict(zip(list("干兑离震巽坎艮坤"),[126,132,138,144,150,156,162,168]))
    ...
    def guaike(self, year, month, day, hour, minute,  gua1, gua2):
        ...
        dgz = gz[2]
        hgz = gz[3]
        gua_code = dict(zip(list(range(0,11)),list("艮艮兑坎离震巽巽坤干")))
    ...
    def Ganzhiwuxing(self, gangorzhi):
        ganzhiwuxing = dict(zip(list(map(lambda x: tuple(x),"甲寅乙卯震巽,丙巳丁午离,壬亥癸子坎,庚申辛酉干兑,未丑戊己未辰戌艮坤".split(","))), list("木火水金土")))
...
#后天策轨数
    ...
    def display_pan_m(self, year, month, day, hour, minute, mgua):
        ...
        eightgua = { '777':"干金",  '778':"兑金",  '787':"离火",  '788':"震木",  '877':"巽木", '878':"坎水",  '887':"艮土",  '888':"坤土"}
